...
public class recuperar_contrasena extends AppCompatActivity implements View.OnClickListener {
...
/*
    public class AsyncTask_Load extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPostExecute(Void result){
            ...
            Toast.makeText(recuperar_contrasena.this, "Se ha enviado un correo", Toast.LENGTH_LONG).show();
